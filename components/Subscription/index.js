  ...
  render() {
    return (
      <div className="d-flex justify-content-center text-center">
        {this.state.userSelectedPlan1 ? (
          <div className={styles.mainContainer}>
            <div className={styles.planHeadline}>
              <div className={styles.TitleBox}>
                Make the most of these productivity tools. <br /> Subscribe
                today, to get full access.{" "}
              </div>{" "}
            </div>
                    ...
                    <div className={styles.shadow1}>
                      <div className={styles.plan1}>
                        ...
                        <div className={styles.priceStyle}>
                          99 INR<span className={styles.priceDur}> /month</span>
                        </div>
                        <div d-flex justify-content-center text-center>
                          <div
                            onClick={() => this.userSelectedPlan1()}
                  ...
                  <div className="col-xs">
                    <div className={styles.shadow2}>
                      <div className={styles.plan2}>
                        Annual
                        <hr />
                        <div className={styles.priceStyle1}>
                          {" "}
                          <strike className={styles.strikeStyles}>
                            {" "}
                            1,188 INR
                          </strike>{" "}
                          <br /> 499 INR
                          <span className={styles.priceDur}> /year</span>
                        </div>
            ...
            <div className="d-flex justify-content-center text-center">
              <div className={styles.planSubHeadline}>
                We are offering two plans at the moment, select the one which
                suits you best.{" "}
              </div>
            </div>
          </div>
        ) : null}
        {this.state.userSelectedPlan1_ ? (
          <div className={styles.plan1Styles}>
            ...
            <div className="d-flex justify-content-center text-center">
              <div className={styles.plan1PriceOuterBox}>
                ...
                <div className={styles.plan1CheckOut}>per month</div>
                <div className="d-flex justify-content-center text-center">
                  <div className={styles.planConfirmPageBtnBox}>
                    <button
                      onClick={() => this.BackToSubPage()}
